...
########################################################################
#
# title:          Build Jenkins Master Image based on Ubuntu 16.04
# author:         Marco Maccio (http://marmac.name)
# url:            https://github.com/marcomaccio/devpaas
# description:    Create image for Jenkins Master server based on Ubuntu 16.04 ISO image
#
# to run:
#         sh VBOX-build-image-devpaas-jenkins-ubuntu-server-1604.sh virtualbox-iso          \
#                                                               -debug                      \
#                                                               IMAGE_ISO_URL               \
#                                                               ATLAS_USERNAME              \
#                                                               ATLAS_TOKEN                 \
...
export PACKER_LOGS_FILENAME="VBOX-packer-jenkins-ubuntu-server-1604.log"
...
export PRESEED_FILENAME=${14}           # ex. preseed-jenkins-ubuntu-server-1604.cfg
...
export PACKER_TEMPLATE=templates/jenkins/packer-jenkins-ubuntu-server-1604.json
