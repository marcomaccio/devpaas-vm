...
################################################################################################
#
# title:          Build Jenkins Image based on Ubuntu 16.04
# author:         Marco Maccio (http://marmac.name)
# url:            https://github.com/marcomaccio/devpaas
# description:    Create image for Jenkins server based on Ubuntu 16.04 image
#
# to run:
#           sh AWS-build-image-devpaas-jenkins-ubuntu-server-1604.sh amazon-ebs                \
#                                                               AWS_SSH_USERNAME            \
#                                                               AWS_SSH_KEYPAIR_NAM         \
...
export PACKER_LOGS_FILENAME="AWS-packer-jenkins-ubuntu-server-1604.log"
